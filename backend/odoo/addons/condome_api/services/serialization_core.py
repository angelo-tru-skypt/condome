...
class ApiSerializationCoreMixin:
    ...
    def serialize_condominio(self, record):
        return {
            ...
            "totales": {
                ...
                "residentes": len(record.residente_ids.filtered("activo")),
            },
        }
    ...
    def serialize_edificio(self, record):
        return {
            ...
            "total_apartamentos": len(record.apartamento_ids),
        }
    ...
    def serialize_apartamento(self, record):
        return {
            ...
            "residentes_count": len(record.residente_ids.filtered("activo")),
        }
