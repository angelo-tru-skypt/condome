      ...
      <div className="flex items-center justify-center min-h-[60vh]">
        <div className={`${SURFACE} max-w-xl p-8 text-center`}>
          ...
          <p className="text-sm text-[#737373] mt-2">
            Esta ruta no tiene una vista configurada para el propietario.
          </p>
        </div>
      </div>
    );
                ...
                {module.indicators.map((indicator) => (
                  ...
                  >
                    ...
                    <p className="text-xs text-white/58 mt-1">
                      Vista enfocada en consulta y seguimiento del propietario.
                    </p>
                  </div>
                ))}
              </div>
          ...
          <div className="flex items-center justify-between gap-4 flex-wrap">
            <div>
              ...
              <h2 className="mt-2 text-xl font-semibold text-[#E5E5E5]">
                Lo que sí puede hacer el propietario en este espacio
              </h2>
            </div>
            <span className="px-3 py-1.5 rounded-full bg-[#FFF0E7] text-[#B14F12] text-xs font-semibold">
              Experiencia sin permisos administrativos
            </span>
          </div>
              ...
              {module.related.map((item) => (
                ...
                >
                  ...
                  <p className="text-xs text-[#737373] mt-1">
                    Navega entre vistas permitidas para el propietario.
                  </p>
                </Link>
              ))}
            </div>
          ...
          <div className={`${SURFACE} p-6`}>
            ...
            <div className="mt-4 rounded-[24px] border border-dashed border-[#E4D9D0] bg-[#141414] p-5">
              <p className="text-sm leading-7 text-[#A3A3A3]">
                Esta vista está pensada para seguimiento, consulta y contexto. Las acciones de
                publicación, configuración o administración global permanecen en el panel del
                administrador.
              </p>
            </div>
          </div>
